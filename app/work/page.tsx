...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Crypto app, In which we can track the live stocks positions and buy and sell the stocks.",
    stack: [{ name: "Swift" }, { name: "SwiftUI" }],
    image: "/assets/pro1.png",
    github: "https://github.com/Omkaranrse/Crypto-App",
  },
  {
    num: "02",
    category: "frontend",
